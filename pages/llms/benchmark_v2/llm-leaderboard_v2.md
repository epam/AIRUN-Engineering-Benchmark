...
![llm-previous-rating.png](/images/llms/benchmark_v2/llm-previous-rating.png)
...
![llm-type.png](/images/llms/benchmark_v2/llm-is_commercial.png)
![llm-price.png](/images/llms/benchmark_v2/llm-price.png)
![llm-tokens.png](/images/llms/benchmark_v2/llm-tokens.png)
![llm-cost.png](/images/llms/benchmark_v2/llm-cost.png)
...
You can read [llm-comparison-report.md](llm-comparison-report_v2.md) for a detailed comparison of the models. The report includes all experiment scores, the performance of each model in different

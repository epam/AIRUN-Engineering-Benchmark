# LLMs Leaderboard (Benchmark v3, last update 2025-11-20)
...
- GPT-5.1 (11-13) leads with 83.36% (68.46 min, $3.64), with high reasoning variant at 83.96% (171.48 min, $7.87) - minimal improvement (+0.6%) at 2.5x cost
...
- gpt-oss-120b achieves 62.19% with fastest execution (6.71 min, 555.99 T/S) and ultra-low cost ($0.23)
...
- GPT-5 Mini scores 79.21% in second place, significantly outperforming coding (71.28%) with excellent cost-efficiency ($0.48)
- GPT-5.1 (11-13) achieves 74.17%, regular variant outperforms high reasoning (70.43%) - opposite of coding pattern
- Claude Haiku 4.5 scores 61.13% with fastest execution (4.64 min, $0.91), significantly behind coding performance (81.83%)
...
- **Fastest token generation**: gpt-oss-120b (555.99 T/S), Claude Haiku 4.5 (180.66 T/S), Grok Code Fast (165.54 T/S), Grok 4 Fast (125.84 T/S), Gemini 3 Pro Preview (93.72 T/S)
- **Shortest execution time**: gpt-oss-120b (6.71 min), Grok Code Fast (17.66 min), Grok 4 Fast (41.22 min), Gemini 3 Pro Preview (44.32 min), Claude Haiku 4.5 (59.27 min)
- **Most tokens generated**: GPT-5.1 (11-13) (high) (747,615 tokens), GPT-5 Mini (649,773 tokens), Claude Haiku 4.5 (642,436 tokens), Claude Sonnet 4.5 (496,983 tokens), MiniMax M2 (327,231 tokens)
- **Best cost-effectiveness**: Grok 4 Fast ($0.22), gpt-oss-120b ($0.23), GPT-5 Nano ($0.33), Grok Code Fast ($0.33), MiniMax M2 ($0.49)

**Multimodal Benchmark:**

- **Fastest token generation**: Grok 4 Fast (91.42 T/S), GPT-5 Nano (86.49 T/S), Gemini 3 Pro Preview (81.67 T/S), Claude Haiku 4.5 (74.89 T/S), GPT-5 Mini (52.28 T/S)
- **Shortest execution time**: Claude Haiku 4.5 (4.64 min), Claude Sonnet 4.5 (8.46 min), GPT-5 Codex (11.67 min), Grok 4 Fast (14.22 min), Amazon Nova Premier (14.85 min)
- **Best cost-effectiveness**: GPT-5 Nano ($0.13), Grok 4 Fast ($0.16), GPT-5 Mini ($0.48), Claude Haiku 4.5 ($0.91), GPT-5 Codex ($1.11)

Best results by category:

**Coding Benchmark:**

- **Code Translation**: GPT-5.1 (11-13) (high) (84.71%), GPT-5.1 (11-13) (84.17%), Claude Haiku 4.5 (82.63%), GPT-5 Codex (81.67%), MiniMax M2 (81.63%), GPT-5 Mini (80.92%)
- **Code Generation**: GPT-5 Codex (81.42%), Grok 4 Fast (80.38%), GPT-5.1 (11-13) (high) (78.96%), GPT-5.1 (11-13) (77.65%), Claude Sonnet 4.5 (75.92%), Claude Haiku 4.5 (74.04%)
...
- **LCIF**: Grok Code Fast (98.50%), Claude Sonnet 4.5 (96.25%), Gemini 3 Pro Preview (96.25%), Grok 4 (92.50%), GPT-5.1 (11-13) (high/none) (91.25%), Claude Haiku 4.5 (90.00%)

**Multimodal Benchmark:**

- **Overall Multimodal Performance**: Gemini 3 Pro Preview (82.54%), GPT-5 Mini (79.21%), GPT-5.1 (11-13) (74.17%), GPT-5 Codex (73.06%), GPT-5.1 (11-13) (high) (70.43%)
...
- xAI Grok: coding-focused (79.45%), multimodal struggles (50.74%)
- Claude: coding-optimized (82.19%), multimodal regression (54.76%)
...
- Price increase: Gemini 3 from $1.25/$10 to $2/$12 for <200K context

**Top Performers by Use Case**

- Coding: GPT-5.1 (11-13) for performance/cost balance, Claude Haiku 4.5 for speed, Grok 4 Fast for cost ($0.22)
- Multimodal: Gemini 3 Pro Preview for accuracy, GPT-5 Mini for cost ($0.48), Claude Haiku 4.5 for speed (4.64 min)

...
- Grok 4 (07-09) delivers consistent mid-tier performance (91.24%) with balanced capabilities across all categories, but suffers from slow generation speed (42.03 tokens/sec) that makes it less
  suitable for interactive development workflows despite reasonable cost efficiency ($2.07), so we are waiting for coding model by xAI announced on Grok 4 release
...
| Grok 4 (07-09)                   | Yes          | 3.918    | 3.801        | 48.32            | 42.03       | 80121       | 121850       | 2.07   | 91.24%      |
